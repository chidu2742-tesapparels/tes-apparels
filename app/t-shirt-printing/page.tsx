        ...
        <div className="mx-auto max-w-7xl px-6 py-10 sm:px-8 lg:px-10">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            <h2 className="text-2xl font-bold text-[#0B2341]">
              Explore T-Shirt Printing & Embroidery
            </h2>
            ...
            <p className="mt-3 max-w-4xl leading-7 text-slate-600">
              ...
              sublimation. For premium logo branding and durable corporate
              apparel, explore our{" "}
              <a
              ...
              services for logos, uniforms, polo T-shirts and promotional
              apparel. For businesses requiring bulk customized apparel
